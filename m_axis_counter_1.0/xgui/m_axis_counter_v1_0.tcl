...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NUMBER_OF_OUTPUT_WORDS"
  set C_M00_AXIS_WAIT_COUNT [ipgui::add_param $IPINST -name "C_M00_AXIS_WAIT_COUNT"]
  set_property tooltip {Wait period between tready and tvalid} ${C_M00_AXIS_WAIT_COUNT}

}

proc update_PARAM_VALUE.C_M00_AXIS_WAIT_COUNT { PARAM_VALUE.C_M00_AXIS_WAIT_COUNT } {
	# Procedure called to update C_M00_AXIS_WAIT_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXIS_WAIT_COUNT { PARAM_VALUE.C_M00_AXIS_WAIT_COUNT } {
	# Procedure called to validate C_M00_AXIS_WAIT_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_AXIS_WAIT_COUNT { MODELPARAM_VALUE.C_M00_AXIS_WAIT_COUNT PARAM_VALUE.C_M00_AXIS_WAIT_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_AXIS_WAIT_COUNT}] ${MODELPARAM_VALUE.C_M00_AXIS_WAIT_COUNT}
}
